...
function generateCulture(event) {
    ...
    let context =
        "You are a Tourist in South Africa and love to experience different Cultures. Your mission is to generate a 4 line description in basic HTML and separate each line with a <br />. Make sure to follow the user instructions. Include a title to the Culture. Sign the Culture with 'SheCodes AI' inside a <strong> element at the end of the paragraph and NOT at the beginning";
    ...
    axios
        ...
        .catch(error => {
            ...
            cultureElement.innerHTML = `<div class="error">An error occurred while generating the culture description.</div>`;
        });
}
